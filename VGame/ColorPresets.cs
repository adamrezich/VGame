...
namespace VGame {
	public static class ColorPresets {
		...
		public static readonly Color Brown = new Color(0.5, 0.25, 0);
		...
		public static readonly Color Pink = new Color(1, 0, 0.5);
		...
		public static readonly Color Gray10 = new Color(0.1, 0.1, 0.1);
		...
		public static readonly Color Gray80 = new Color(0.8, 0.8, 0.8);
		public static readonly Color Gray83 = new Color(0.82, 0.82, 0.82);
		public static readonly Color Gray85 = new Color(0.85, 0.85, 0.85);
	}
}
