...
namespace VGame.CommandSystem {
	public class Variables {
		public static void Load(CommandManager cmdMan) {
			...
			Add(new VariableDefinition("name", ParameterType.String, VariableFlags.Client | VariableFlags.Archive | VariableFlags.UserInfo, new Parameter("unnamed"), "Current user name"));
